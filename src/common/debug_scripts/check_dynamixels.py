...
# parser.add_argument("usb_full_path", help="The full path to dynamixel USB bus e.g.: /dev/hello-dynamixel-head", default="dev/hello-dynamixel-head")
args = parser.parse_args()
args.usb_full_path = "/dev/hello-dynamixel-head"
m=None
nfind=0
try:
