...
class VLMaps():
    ...
    def __init__(self, params: dict):
        ...
        checkpoints_dir = os.path.join(self.root_dir, "lseg", "checkpoints")
    ...
    def get_tf_base2cam(self,):
        ...
        add_params_dir = os.path.join(self.data_dir, "add_params")
    ...
    def get_movebase_goals(self,results:dict,label:str):
        ...
        initial_pose_path = os.path.join(self.data_dir, '..','..','debug_scripts/amcl_pose.json')
...
if __name__ == "__main__":
    ...
    if(params["data_dir"] is None):
        data_dir = os.path.join(params["root_dir"], "data", "sim_rosbag_data/")
