...
class TestTaskPlanner:
    ...
    def go_to_object(self, objectName):
        ...
        self.navigate_to_location(movebase_goal)
    ...
    def get_movebase_goals(self,results:dict,label:str)-> MoveBaseGoal:
        ...
        initial_pose_path = os.path.join(self.root_dir, 'config/amcl_pose.json')
        ...
        # Make Z =0 and yaw =0 for 2d navigation. Theta in degrees!
        Z = 0; theta =0 
